...
const char* RectToString(const RECT* rect) {
  ...
  static char buffers[BUFFERS][64];
  if (!rect)
    return "NULL_RECT";
  sprintf_s(buffers[cBuffer], 64, "RECT[%4ld/%4ld/%4ld/%4ld]", rect->left, rect->top, rect->right,
            rect->bottom);
  char* ret = buffers[cBuffer];
  cBuffer++;
  cBuffer %= BUFFERS;
  return ret;
}
...
const char* D3DMatrixToString(const D3DMATRIX* pMatrix) {
  const int BUFFERS = 64;
  static int cBuffer = 0;
  static char buffers[BUFFERS][256];
  if (!pMatrix)
    return "NULL_MATRIX";
  ...
  for (int i = 0; i < 4; ++i) {
    pos += std::sprintf(pos, " | ");
    for (int j = 0; j < 4; ++j) {
      pos += std::sprintf(pos, "%6.2f ", pMatrix->m[i][j]);
    }
    pos += std::sprintf(pos, "\n");
  }
  char* ret = buffers[cBuffer];
...
const char* D3DFormatToString(D3DFORMAT format, bool bWithPrefix) {
  ...
  case D3DFMT_A8R8G8B8:
    pstr = "D3DFMT_A8R8G8B8";
    break;
  case D3DFMT_X8R8G8B8:
    pstr = "D3DFMT_X8R8G8B8";
    break;
  case D3DFMT_R5G6B5:
    pstr = "D3DFMT_R5G6B5";
    break;
  case D3DFMT_X1R5G5B5:
    pstr = "D3DFMT_X1R5G5B5";
    break;
  case D3DFMT_A1R5G5B5:
    pstr = "D3DFMT_A1R5G5B5";
    break;
  case D3DFMT_A4R4G4B4:
    pstr = "D3DFMT_A4R4G4B4";
    break;
  case D3DFMT_R3G3B2:
    pstr = "D3DFMT_R3G3B2";
    break;
  ...
  case D3DFMT_A8R3G3B2:
    pstr = "D3DFMT_A8R3G3B2";
    break;
  case D3DFMT_X4R4G4B4:
    pstr = "D3DFMT_X4R4G4B4";
    break;
  case D3DFMT_A2B10G10R10:
    pstr = "D3DFMT_A2B10G10R10";
    break;
  case D3DFMT_A8B8G8R8:
    pstr = "D3DFMT_A8B8G8R8";
    break;
  case D3DFMT_X8B8G8R8:
    pstr = "D3DFMT_X8B8G8R8";
    break;
  case D3DFMT_G16R16:
    pstr = "D3DFMT_G16R16";
    break;
  case D3DFMT_A2R10G10B10:
    pstr = "D3DFMT_A2R10G10B10";
    break;
  case D3DFMT_A16B16G16R16:
    pstr = "D3DFMT_A16B16G16R16";
    break;
  case D3DFMT_A8P8:
    pstr = "D3DFMT_A8P8";
    break;
  ...
  case D3DFMT_X8L8V8U8:
    pstr = "D3DFMT_X8L8V8U8";
    break;
  case D3DFMT_Q8W8V8U8:
    pstr = "D3DFMT_Q8W8V8U8";
    break;
  case D3DFMT_V16U16:
    pstr = "D3DFMT_V16U16";
    break;
  case D3DFMT_A2W10V10U10:
    pstr = "D3DFMT_A2W10V10U10";
    break;
  case D3DFMT_UYVY:
    pstr = "D3DFMT_UYVY";
    break;
  case D3DFMT_R8G8_B8G8:
    pstr = "D3DFMT_R8G8_B8G8";
    break;
  case D3DFMT_YUY2:
    pstr = "D3DFMT_YUY2";
    break;
  case D3DFMT_G8R8_G8B8:
    pstr = "D3DFMT_G8R8_G8B8";
    break;
  case D3DFMT_DXT1:
    pstr = "D3DFMT_DXT1";
    break;
  ...
  case D3DFMT_D32F_LOCKABLE:
    pstr = "D3DFMT_D32F_LOCKABLE";
    break;
  case D3DFMT_D24FS8:
    pstr = "D3DFMT_D24FS8";
    break;
  case D3DFMT_D32_LOCKABLE:
    pstr = "D3DFMT_D32_LOCKABLE";
    break;
  case D3DFMT_S8_LOCKABLE:
    pstr = "D3DFMT_S8_LOCKABLE";
    break;
  case D3DFMT_L16:
    pstr = "D3DFMT_L16";
    break;
  case D3DFMT_VERTEXDATA:
    pstr = "D3DFMT_VERTEXDATA";
    break;
  case D3DFMT_INDEX16:
    pstr = "D3DFMT_INDEX16";
    break;
  ...
  case D3DFMT_Q16W16V16U16:
    pstr = "D3DFMT_Q16W16V16U16";
    break;
  case D3DFMT_MULTI2_ARGB8:
    pstr = "D3DFMT_MULTI2_ARGB8";
    break;
  case D3DFMT_R16F:
    pstr = "D3DFMT_R16F";
    break;
  ...
  case D3DFMT_A2B10G10R10_XR_BIAS:
    pstr = "D3DFMT_A2B10G10R10_XR_BIAS";
    break;
  case D3DFMT_BINARYBUFFER:
    pstr = "D3DFMT_BINARYBUFFER";
    break;
  default:
    pstr = "       Unknown format";
    break;
  }
  return bWithPrefix ? pstr : pstr + strlen("D3DFMT_");
}
